...
class DeadlineExceededException extends ApiException {
  ...
  DeadlineExceededException() : super(message: _kErrorMessage);
}
...
class UnauthorizedException extends ApiException {
  ...
  UnauthorizedException({String? message})
      : super(message: message ?? _kErrorMessage, code: HttpStatus.unauthorized);
}
...
class NotFoundException extends ApiException {
  ...
  NotFoundException()
      : super(message: _kErrorMessage, code: HttpStatus.notFound);
}

class UserNotFoundException extends ApiException {
  static const String _kErrorMessage = "User Not Found";
  UserNotFoundException({String? errorMessage})
      : super(message: errorMessage ??_kErrorMessage, code: HttpStatus.notFound);
}
